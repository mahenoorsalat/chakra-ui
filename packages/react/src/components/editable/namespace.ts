...
export type {
  ...
  EditableInteractOutsideEvent as InteractOutsideEvent,
  EditableFocusOutsideEvent as FocusOutsideEvent,
  EditablePointerDownOutsideEvent as PointerDownOutsideEvent,
